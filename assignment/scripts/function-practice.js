...
console.log('Test helloName- should say "Hello, NAME!"', helloName('Emma'));
...
function find(value, array) {
  ...
  for (let i = 0; i<array.length; i++) {
    if (array[i] === value) {
      anyTrue ++;
      console.log('Test anyTure value:', anyTrue);
    }
  }
    if (anyTrue > 0){
      return true;
...
console.log('Test find - should return "1" and "true"', find(21, [20, 21, 22]));
console.log('Test find - should return "false"', find(2, [20, 21, 23, 25]));
console.log('Test find - should return "3" and "ture"', find(2.5, [2.5, 6.2, 9.2, 2.5, 109, 2.5, ]) );
...
function allPositive(array) {
  let positives = [];
  console.log('in allPositives', array);
   for (let i=0; i < array.length; i++ ){  
    if (array[i] > 0){
      positives.push(array[i]);
      console.log('in loop', positives); 
    }
  }
    return positives;
}
